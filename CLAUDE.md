...
See `../Bifrost/CLAUDE.md` (§2 The Naming Model) and `../Glitnir/CLAUDE.md` (§1 Bounded Context Map, §4 Messaging) for the full realm table, the messaging decision (NServiceBus 10.2, `ReceiveOnly`, source-generated handler registration), and how Ratatoskr fits the rest of the cosmos.
